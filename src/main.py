...
def install_system():
    packages = "base linux linux-firmware vim sudo grub git efibootmgr os-prober networkmanager openbox lightdm  lightdm-gtk-greeter xorg xorg-server xorg-xinit kitty xdg-utils tint2 thunar firefox"
