...
def install_system():
    packages = "base base-devel linux linux-firmware vim sudo grub git efibootmgr os-prober networkmanager openbox ly xorg xorg-xauth xorg-server xorg-xinit xdg-utils tint2 thunar firefox xorg-xterm plank"
